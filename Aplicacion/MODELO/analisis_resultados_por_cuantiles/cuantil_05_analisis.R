### =========================================
### 1. CARGA DE MODELOS Y PREPROCESAMIENTO
### =========================================

# Cargar los modelos particionados
load("particion1_modelo_completo_sub205.RData"); fit2 <- fit5
load("particion1_modelo_completo_sub305.RData"); fit3 <- fit7
load("particion1_modelo_completo_sub405.RData"); fit4 <- fit9
load("particion1_modelo_completo05.RData");     fit1 <- fit12
...
write.csv(tabla_resultados, "tabla_resultados_alpha_05.csv", row.names = FALSE)
...
ggsave("sigma_05.pdf", plot = plot_sigma, width = 8, height = 6, units = "in", dpi = 300)
...
ggsave("sigma_cole_05.pdf", plot = plot_sigma_cole, width = 8, height = 6, units = "in", dpi = 300)
...
ggsave("mu_global_05.pdf", plot = plot_mu_global, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 4: Guardar el gráfico
ggsave("edad_posterior_05.pdf", plot = plot_beta_age, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 4: Guardar el gráfico
ggsave("municipios_05.pdf", plot = municipios, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 6: Guardarlo
ggsave("colegios_05.pdf", plot = colegios, width = 10, height = 7, units = "in", dpi = 300)
...
# --- Paso 6: Guardarlo
ggsave("estrato_posterior_05.pdf", plot = estrato, width = 8, height = 6, units = "in", dpi = 300)
...
ggsave("internet_05.pdf", plot = internet, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 4: Guardarlo
ggsave("naturaleza_posterior_05.pdf", plot = plot_naturaleza, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 6: Guardarlo
ggsave("horas_05.pdf", plot = horas, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 6: Guardarlo
ggsave("madre_05.pdf", plot = madre, width = 8, height = 6, units = "in", dpi = 300)
...
# --- Paso 6: Guardarlo
ggsave("padre_05.pdf", plot = padre, width = 8, height = 6, units = "in", dpi = 300)
...
for (param in parametros) {
  ...
  # Guardarlo
  nombre_archivo <- paste0("Traceplots/Traceplot05_", gsub("\\[|\\]", "_", param), ".pdf")
